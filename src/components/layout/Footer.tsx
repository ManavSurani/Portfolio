  ...
  return (
    <footer className="border-t border-border/80 bg-background py-12">
      ...
      >
        <div className="flex flex-col md:flex-row items-center justify-between gap-6">
          <div className="text-center md:text-left">
            <div className="flex items-center justify-center md:justify-start gap-2.5 mb-2">
              <div className="w-7 h-7 rounded-full overflow-hidden border border-sand-DEFAULT shadow-xs shrink-0">
                <Image
        ...
        <div className="mt-8 pt-6 border-t border-border/40 flex flex-col sm:flex-row items-center justify-between text-xs text-muted">
