      ...
      <main className="flex-grow pt-24 pb-12">
          ...
          <div className="w-full flex flex-col md:flex-row items-center justify-between gap-12">
            ...
            >
              <motion.div variants={fadeUp}>
                <h2 className="text-coral-400 font-medium tracking-wider mb-2 uppercase">Hello, World!</h2>
                ...
                <p className="text-xl md:text-2xl text-muted max-w-lg font-light">
              ...
              <motion.div variants={fadeUp} className="flex flex-wrap gap-4 pt-4">
                ...
                <a href="/resume.pdf" target="_blank" rel="noopener noreferrer">
                  <Button variant="outline" size="lg" className="gap-2 text-teal-300 border-teal-500/50 hover:bg-teal-500/10">
            ...
            >
              <div className="relative w-72 h-72 md:w-96 md:h-96 rounded-full p-2 bg-gradient-to-tr from-coral-500 via-surface to-teal-500 glow-coral">
                <div className="w-full h-full rounded-full overflow-hidden bg-background relative border-4 border-background">
                  ...
                  <div className="absolute inset-0 bg-coral-900/20 mix-blend-overlay"></div>
                </div>
              </div>
            </motion.div>
          </div>
        ...
        <section id="about" className="py-24 container mx-auto px-6 max-w-7xl relative">
          ...
          >
            ...
            <div className="grid md:grid-cols-2 gap-12 mt-16">
              <div className="glass p-8 rounded-2xl border-l-4 border-l-coral-500">
                <h3 className="text-2xl font-bold mb-4 text-coral-100">My Journey</h3>
              ...
              <div className="space-y-6">
                <div className="glass p-6 rounded-2xl border-l-4 border-l-teal-500">
                  <h4 className="text-xl font-bold text-teal-100">Master of Science (MSc) in IT</h4>
                  <p className="text-sm text-coral-300 font-mono mb-2">2025 – 2027 • The Maharaja Sayajirao University of Baroda</p>
                  <p className="text-muted text-sm">Currently in 2nd Year, 3rd Semester. Coursework: Mobile Computing, Data Structures, Database Management.</p>
                </div>
                <div className="glass p-6 rounded-2xl border-l-4 border-l-coral-500/50">
                  <h4 className="text-xl font-bold text-coral-100/80">Bachelor of Science (BSc) in IT</h4>
                  <p className="text-sm text-teal-300 font-mono mb-2">Jul 2022 – May 2025 • CVM University</p>
                  <p className="text-muted text-sm">Graduated with a stellar 8.45 CGPA.</p>
                </div>
              </div>
            </div>
          </motion.div>
            ...
            >
              ...
              <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-8 mt-12">
                <motion.div variants={fadeUp} className="glass p-6 rounded-2xl">
                  <h3 className="text-xl font-semibold mb-6 text-coral-300 border-b border-border pb-2">Languages</h3>
                  <div className="flex flex-wrap gap-3">
                    {["Python", "TypeScript", "JavaScript", "C#", "C++", "Java", "PHP"].map(skill => (
                      <SkillBadge key={skill} name={skill} glow="coral" />
                    ))}
                  </div>
                </motion.div>

                <motion.div variants={fadeUp} className="glass p-6 rounded-2xl">
                  <h3 className="text-xl font-semibold mb-6 text-teal-300 border-b border-border pb-2">Frameworks</h3>
                  <div className="flex flex-wrap gap-3">
                    {["Next.js", "React", "FastAPI", "ASP.NET", ".NET (WinForms)", "Tailwind CSS"].map(skill => (
                      <SkillBadge key={skill} name={skill} glow="teal" />
                    ))}
                  </div>
                </motion.div>

                <motion.div variants={fadeUp} className="glass p-6 rounded-2xl">
                  <h3 className="text-xl font-semibold mb-6 text-coral-300 border-b border-border pb-2">Databases</h3>
                  <div className="flex flex-wrap gap-3">
                ...
                <motion.div variants={fadeUp} className="glass p-6 rounded-2xl">
                  <h3 className="text-xl font-semibold mb-6 text-teal-300 border-b border-border pb-2">Tools & AI</h3>
                  <div className="flex flex-wrap gap-3">
        ...
        <section id="experience" className="py-24 container mx-auto px-6 max-w-7xl">
          ...
          >
            ...
            <div className="mt-16 relative before:absolute before:inset-0 before:ml-5 md:before:mx-auto md:before:translate-x-0 before:h-full before:w-0.5 before:bg-gradient-to-b before:from-coral-500 before:via-teal-500 before:to-transparent">
              <div className="relative flex items-center justify-between md:justify-normal md:odd:flex-row-reverse group is-active">
                <div className="flex items-center justify-center w-10 h-10 rounded-full border-4 border-background bg-coral-500 shadow shadow-coral-500/50 shrink-0 md:order-1 md:group-odd:-translate-x-1/2 md:group-even:translate-x-1/2 ml-[2px] md:ml-0 z-10 glow-coral"></div>
                <div className="w-[calc(100%-4rem)] md:w-[calc(50%-2.5rem)] glass p-8 rounded-2xl shadow-xl ml-4 md:ml-0">
                  <div className="flex flex-col mb-4">
                    <span className="text-coral-400 font-mono text-sm mb-1">Summer Internship</span>
                    <h3 className="text-2xl font-bold text-foreground">Software Engineering Intern</h3>
                    <h4 className="text-lg font-medium text-teal-300">VN Code Pro</h4>
                  </div>
                  <ul className="space-y-3 text-muted text-sm list-disc pl-4">
            ...
            <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6 mt-12">
              {[
                ...
                <motion.a 
                  ...
                  className="glass p-6 rounded-xl border border-border/50 hover:border-coral-500/50 hover:glow-coral transition-all duration-300 group flex flex-col justify-between h-full"
                >
                  <div>
                    <h4 className="font-bold text-foreground group-hover:text-coral-200 transition-colors">{cert.title}</h4>
                    <p className="text-teal-400 text-sm mt-2">{cert.org}</p>
                  </div>
        ...
        <section id="contact" className="py-24 bg-surface/30 border-t border-border/50">
          <div className="container mx-auto px-6 max-w-3xl text-center">
            <motion.div
              ...
              variants={fadeUp}
            >
              <h2 className="text-4xl md:text-5xl font-bold mb-6 text-transparent bg-clip-text bg-gradient-to-r from-coral-500 to-teal-500">
